...
public class FactoredLargeHashMap<K,V> implements LargeHashMap<K, V> {
	
	private final LargeHashCore<LargeHashMap.Entry<K,V>> hashCore;
	private final LargeHashMap.KeyAdapter<K> keyAdapter;
	
	public FactoredLargeHashMap(int segSize, int initSegCount, float loadFactorThreshold, LargeHashMap.KeyAdapter<K> keyAdapter) {
	...
	public FactoredLargeHashMap(int segSize, int initSegCount, float loadFactorThreshold) {
